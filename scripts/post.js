...
function toggleEditSaveMode () {
  ...
  if (document.getElementById('blog-title').contentEditable == 'false') {
    ...
    document.getElementById('blog-body').contentEditable = 'true'

    //Change icon from 'edit' to 'save'
    editSaveIcon =
      'Save <i style="font-size: 14px;" class="fa fa-save" id="edit-save-icon"></i>'
    document.getElementById('blog-edit-save-btn').innerHTML = editSaveIcon
    ...
    document.getElementById('blog-body').style.border = '2px solid pink'
  }
  //If the title IS in editable mode - switch to non EDIT mode ie SAVE mode
    ...
    document.getElementById('blog-body').contentEditable = 'false'

    //Change icon from 'edit' to 'save'
    editSaveIcon =
      'Edit <i style="font-size: 14px;" class="fa fa-edit" id="edit-save-icon"></i>'
    document.getElementById('blog-edit-save-btn').innerHTML = editSaveIcon
    ...
    document.getElementById('blog-body').style.border = 'none'
  }
}
...
function addComment () {
  ...
  document.getElementById('add-comments-to-list').style['background-color'] =
    'lightgray'
